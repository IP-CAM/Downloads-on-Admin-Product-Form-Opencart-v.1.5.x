...
<table class="form">
	<tr>
	  <td><span class="required">*</span> <?php echo $entry_digital_download; ?></td>
	  <td><div class="scrollbox" style="min-height:250px;">
		  <?php $class = 'odd'; ?>
		  <?php foreach ($digital_downloads as $digital_download) { ?>
		  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
		  <div class="<?php echo $class; ?>">
			<?php if (in_array($digital_download['download_id'], $product_downloads)) { ?>
